 ...
 * @since 2019-03-19
 */
@TableName("cf_stock_return_line")
@ApiModel(value="CfStockReturnLine",description="备料退货扫描行表")
@Data
public class CfStockReturnLine extends Model<CfStockReturnLine> {
    ...
    public static final String  LAST_UPDATED_DATE_SQL = "last_update_date";//备料清单表主键
    ...
    public static final String  EX_BAR_CODE_NUMBER_USED = "条码已在库，请注意！";
    ...
    public static final String  EX_BAR_CODE_CANT_USER = "条码对应单据不符或条码已经在库";
    ...
    public static final String  EX_REPOSITORY_NOT_HAVING = "退料仓库不可为空";
    /**
     * 备料扫描记录主键
     */
...
CP EG是序列号
     ...
     */
    @ApiModelProperty(value="条码类型(KTM：KTM,CP：CP,EG:发动机 ，OT：WP车架条码（库存条码）配件条码CP EG是序列号 ")
